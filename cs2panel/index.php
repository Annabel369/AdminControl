...
<body>
  ...
  Painel de Administração</h1>
    </div>

    <div class="tab-container">
      <button class="tab-button active" data-tab="admins"><i class="fas fa-user-shield icon-small"></i>Admins</button>
      <button class="tab-button" data-tab="bans"><i class="fas fa-gavel icon-small"></i>Banidos (SteamID)</button>
      <button class="tab-button" data-tab="ip_bans"><i class="fas fa-network-wired icon-small"></i>Banidos (IP)</button>
      <button class="tab-button" data-tab="mutes"><i class="fas fa-volume-mute icon-small"></i>Mutados</button>
    </div>
    ...
    <div id="bans" class="content-section">
      <h2>Banidos e Desbanidos (SteamID)</h2>
      <table>
        <thead>
          <tr>
            <th>Status</th>
    ...
    <div id="ip_bans" class="content-section">
      ...
      <!--debug <div id="data-output"></div> -->

    </div>

    <div id="mutes" class="content-section">
      <h2>Mutados e Desmutados</h2>
      <table>
        <thead>
          <tr>
            <th>Status</th>
